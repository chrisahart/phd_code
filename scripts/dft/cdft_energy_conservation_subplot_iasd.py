...
iasd6_2 = np.loadtxt('{}/iasd/nve-hirshfeld-charge7_eps-1e-2_cell-10A-opt3-md-node2.out'.format(folder_2))
iasd7_2 = np.loadtxt('{}/iasd/nve-hirshfeld-charge7_eps-1e-3_cell-10A-opt3-md-node2.out'.format(folder_2))
iasd8_2 = np.loadtxt('{}/iasd/nve-hirshfeld-charge7_eps-1e-4_cell-10A-opt3-md-node2.out'.format(folder_2))
iasd9_2 = np.loadtxt('{}/iasd/nve-hirshfeld-charge7_eps-1e-5_cell-10A-opt3-md-node2.out'.format(folder_2))
iasd10_2 = np.loadtxt('{}/iasd/nve-hirshfeld-charge7_eps-1e-6_cell-10A-opt3-md-node2.out'.format(folder_2))
iasd11_2 = np.loadtxt('{}/iasd/nve-hirshfeld-charge7_eps-1e-7_cell-10A-opt3-md-node2.out'.format(folder_2))
iasd12_2 = np.loadtxt('{}/iasd/dft_from_opt.out'.format(folder_2))
...
iasd7_4 = np.loadtxt('{}/iasd/cdft_eps-1e-2.out'.format(folder_4))
iasd8_4 = np.loadtxt('{}/iasd/cdft_eps-1e-3.out'.format(folder_4))
iasd9_4 = np.loadtxt('{}/iasd/cdft_eps-1e-4.out'.format(folder_4))
iasd10_4 = np.loadtxt('{}/iasd/cdft_eps-1e-5.out'.format(folder_4))
iasd6_4 = np.loadtxt('{}/iasd/dft.out'.format(folder_4))
...
iasd6_51 = np.loadtxt('{}/iasd/dft.out'.format(folder_51))
iasd7_51 = np.loadtxt('{}/iasd/cdft_1e-2.out'.format(folder_51))
iasd8_51 = np.loadtxt('{}/iasd/cdft_1e-3.out'.format(folder_51))
...
iasd6_52 = np.loadtxt('{}/iasd/dft.out'.format(folder_52))
iasd7_52 = np.loadtxt('{}/iasd/cdft_1e-2.out'.format(folder_52))
iasd8_52 = np.loadtxt('{}/iasd/cdft_1e-3.out'.format(folder_52))
...
iasd6_6 = np.loadtxt('{}/iasd/dft.out'.format(folder_6))
iasd7_6 = np.loadtxt('{}/iasd/cdft_eps-1e-2.out'.format(folder_6))
iasd8_6 = np.loadtxt('{}/iasd/cdft_eps-1e-3.out'.format(folder_6))
...
# ax_subplot[0, 0].set_ylim([-1.2, 1.2])
ax_subplot[0, 0].set_ylim([-y_lim, y_lim])
ax_subplot[0, 0].set_ylabel('Energy / micro Ha')

# H2 iasd
ax_subplot[0, 1].plot(time_val7_2, iasd7_2, 'g', label='CDFT 1e-3')
ax_subplot[0, 1].plot(time_val8_2, iasd8_2, 'b', label='CDFT 1e-4')
ax_subplot[0, 1].plot(time_val9_2, iasd9_2, 'y', label='CDFT 1e-5')
ax_subplot[0, 1].plot(time_val12_2, iasd12_2, 'k', label='DFT')
ax_subplot[0, 1].set_xlim([0, time_plot])
ax_subplot[0, 1].set_ylim([0.99, 1.10])
ax_subplot[0, 1].set_ylabel('IASD')
...
# MgO iasd
ax_subplot[1, 1].plot(time_val7_4, iasd7_4, 'r', label='CDFT 1e-2')
ax_subplot[1, 1].plot(time_val8_4, iasd8_4, 'g', label='CDFT 1e-3')
ax_subplot[1, 1].plot(time_val9_4, iasd9_4, 'b', label='CDFT 1e-4')
ax_subplot[1, 1].plot(time_val10_4, iasd10_4, 'y', label='CDFT 1e-5')
ax_subplot[1, 1].plot(time_val6_4, iasd6_4, 'k', label='DFT')
ax_subplot[1, 1].set_xlim([0, time_plot])
ax_subplot[1, 1].set_ylim([0.99, 1.10])
ax_subplot[1, 1].set_ylabel('IASD')
...
# Lepidocrocite iasd
ax_subplot[2, 1].plot(time_val7_6, iasd7_6, 'r', label='CDFT 1e-2')
ax_subplot[2, 1].plot(time_val8_6, iasd8_6, 'g', label='CDFT 1e-3')
ax_subplot[2, 1].plot(np.arange(0, iasd6_6.shape[0]*0.5, 0.5), iasd6_6, 'k', label='DFT')
ax_subplot[2, 1].set_xlim([0, time_plot])
ax_subplot[2, 1].set_ylabel('IASD')
...
# Hematite hole iasd
# ax_subplot[3, 1].plot(time_val7_52, iasd7_52, 'r', label='CDFT 1e-2')
# ax_subplot[3, 1].plot(time_val8_52, iasd8_52, 'g', label='CDFT 1e-3')
ax_subplot[3, 1].plot(np.arange(0, iasd7_52.shape[0]*0.5, 0.5), iasd7_52, 'r', label='CDFT 1e-2')
ax_subplot[3, 1].plot(np.arange(0, iasd8_52.shape[0]*0.5, 0.5), iasd8_52, 'g', label='CDFT 1e-3')
ax_subplot[3, 1].plot(np.arange(0, iasd6_52.shape[0]*0.5, 0.5), iasd6_52, 'k', label='DFT')
ax_subplot[3, 1].set_xlim([0, time_plot])
ax_subplot[3, 1].set_ylabel('IASD')
...
# Hematite electron iasd
ax_subplot[4, 1].plot(time_val7_51, iasd7_51, 'r', label='CDFT 1e-2')
ax_subplot[4, 1].plot(time_val8_51, iasd8_51, 'g', label='CDFT 1e-3')
ax_subplot[4, 1].plot(time_val6_51, iasd6_51, 'k', label='DFT')
ax_subplot[4, 1].set_xlim([0, time_plot])
ax_subplot[4, 1].set_ylabel('IASD')
ax_subplot[4, 1].set_xlabel('Time / fs')

fig_subplot.tight_layout()
# fig_subplot.subplots_adjust(hspace=0)
fig_subplot.savefig('{}/cdft_energy_conservation_iasd_t{}.png'.format(folder_save, time_plot), dpi=parameters.save_dpi, bbbox_inches='tight')
