...
folder_1 = 'E:/University/PhD/Programming/dft_ml_md/output/pentacene/dimer/cdft/analysis'
folder_save_1 = folder_1
energy1_1 = np.loadtxt('{}/energy/unoptimised-charge.out'.format(folder_1))
iasd1_1 = np.loadtxt('{}/iasd/unoptimised-charge.out'.format(folder_1))
...
ax_energy.set_xlim([0, iasd1_1.shape[-1]])
...
xa.set_major_locator(plt.MaxNLocator(integer=True))
ax_iasd.set_xlim([0, iasd1_1.shape[-1]])
