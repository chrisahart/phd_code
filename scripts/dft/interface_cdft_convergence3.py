...
folder_1 = 'E:/University/PhD/Programming/dft_ml_md/output/surfin/dft-md/data/hole/hawk/analysis'
...
folder_2 = 'E:/University/PhD/Programming/dft_ml_md/output/surfin/dft-md/data/hole/hawk/analysis'
energy_kinetic1_2, energy_potential1_2, energy_total1_2, temperature1_2, time_val1_2, time_per_step1_2 = load_energy.load_values_energy(folder_2, 'energy/cdft.out')
energy_kinetic2_2, energy_potential2_2, energy_total2_2, temperature2_2, time_val2_2, time_per_step2_2 = load_energy.load_values_energy(folder_2, 'energy/cdft-absolute.out')
file_spec1_2, species1_2, num_data1_2, step1_2, brent1_2, mnbrack1_2 = read_hirsh(folder_2, '/hirshfeld/cdft.out', atoms, None, None)
file_spec2_2, species2_2, num_data2_2, step2_2, brent2_2, mnbrack2_2 = read_hirsh(folder_2, '/hirshfeld/cdft-absolute.out', atoms, None, None)
...
# file_spec1_3, species1_3, num_data1_3, step1_3, brent1_3, mnbrack1_3 = read_hirsh(folder_3, '/hirshfeld/dt-5_grid-600-40.out', atoms, None, None)
...
# ax_energy.plot(time_val1_1-time_val1_1[0], energy_total1_1, 'k-', label='DFT')
# ax_energy.plot(time_val1_2-time_val1_2[0], energy_total1_2, 'r-', label='CDFT 1e-3')
ax_energy.plot(time_val1_1-time_val1_1[0], (energy_total1_1-energy_total1_1[0])/atoms, 'k.-', label='DFT-MD')
ax_energy.plot(time_val2_2-time_val2_2[0], (energy_total2_2-energy_total2_2[0])/atoms, 'r.-', label='CDFT-MD hole ABS')
ax_energy.plot(time_val1_2-time_val1_2[0], (energy_total1_2-energy_total1_2[0])/atoms, 'g.-', label='CDFT-MD hole REL')
ax_energy.plot(time_val1_3-time_val1_3[0], (energy_total1_3-energy_total1_3[0])/atoms, 'b.-', label='CDFT-MD electron REL')
ax_energy.set_xlabel('Time / fs')
ax_energy.set_ylabel('Energy change per atom / Ha')
ax_energy.set_xlim([0, time_plot])
ax_energy.set_ylim([-4e-6, 3e-4])
