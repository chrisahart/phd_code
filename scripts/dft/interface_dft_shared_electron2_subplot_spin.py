...
for row in range(rows):
    for col in range(cols):
        ...
        #     ax_spin2[row, col].plot(time_val1_2-time_val1_2[0], temp4, '--', color=plot_color[j], label='Fe, polaron')
...
fig_spin2.savefig('{}/fe_spin_fonly_subplot.png'.format(folder_save_2), dpi=300, bbbox_inches='tight')
