...
"""
    Plot Hirshfeld analysis for hematite/water interface electron 
"""
...
energy_kinetic1_1, energy_potential1_1, energy_total1_1, temperature1_1, time_val1_1, time_per_step1_1 = read_energy(folder_1, '/energy/frozen-none.out')
file_spec1_1, species1_1 = read_hirsh(folder_1, '/hirshfeld/frozen-none.out')
...
skip_start_2 = 3
skip_end_2 = 5
# polaron_index = {'00': [129, 30], '01': [129, 30]}
...
x_end = time_val1_1[-1]-time_val1_1[0]
...
for j in range(len(fe_b)):
    for n in range(num_data1_2):
        m = n + 300
        temp1[n] = (file_spec1_2.loc[skip_start_2 + atoms * m + skip_end_2 * m + fe_b[j], 'Spin'])
        temp2[n] = (file_spec1_2.loc[skip_start_2 + atoms * m + skip_end_2 * m + fe_d[j], 'Spin'])
        temp3[n] = (file_spec1_2.loc[skip_start_2 + atoms * m + skip_end_2 * m + fe_f[j], 'Spin'])
