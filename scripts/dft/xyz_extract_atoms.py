...
folder = '/media/chris/DATA/Storage/University/PhD/Programming/Shuttle/work/personal_files/exercises/cdft/MgO/jochen_restart/pbe/weight/pbe_bwa_1_cp2k7_weight_shannon_cut_mgo'
...
atoms = 1 + np.array([15, 16, 19, 20, 27, 39, 67, 63, 68, 64, 56, 52, 55, 51, 66, 62, 65, 61, 54, 50, 53, 49, 13, 14, 17, 18, 25, 37])
atoms_constrain = 1 + np.array([15, 16, 19, 20, 27, 39, 13, 14, 17, 18, 25, 37])
atoms_new = atoms_constrain - np.min(atoms_constrain) + 1
print(atoms_new)
