...
value = 'Spin'
folder = 'F:/Backup/Archer-2/surfin/hematite/dft-md/philipp-shared/bulk/nnp/from_dft_polaron'
folder_save = folder

plot_color = 'r', 'b', 'g', 'c', 'm', 'orange', 'y', 'peru','yellowgreen', 'lightgreen'
topology_file = '{}/topology.xyz'.format(folder)
trajectory_file = '{}/hematite-water-pos-1.xyz'.format(folder)
_, _, _, _, species1_4, _, _ = load_coordinates.load_values_coord(folder, '/topology.xyz')
...
fig_4.tight_layout()
fig_4.savefig('{}/metric_all.png'.format(folder_save), dpi=300, bbbox_inches='tight')
...
fig_6.tight_layout()
fig_6.savefig('{}/metric_color_layer.png'.format(folder_save), dpi=300, bbbox_inches='tight')
...
fig_7.tight_layout()
fig_7.savefig('{}/metric_color_atom.png'.format(folder_save), dpi=300, bbbox_inches='tight')
