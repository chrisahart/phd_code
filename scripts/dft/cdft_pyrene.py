...
folder_1 = 'E:/University/PhD/Programming/dft_ml_md/output/pyrene-cof/supercell_33/pbe/cdft/geo_opt/linker-yes/hirshfeld/analysis/'
folder_save_1 = folder_1
energy1_1 = np.loadtxt('{}/energy/absolute_1-dimer-longer.out'.format(folder_1))
iasd1_1 = np.loadtxt('{}/iasd/absolute_1-dimer-longer.out'.format(folder_1))
...
ax_energy.set_xlim([0, x_end-start-1])
...
xa.set_major_locator(plt.MaxNLocator(integer=True))
ax_iasd.set_xlim([0, x_end-start-1])
ax_iasd.set_ylim([1, 8])
